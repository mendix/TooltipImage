...
(function() {
    ...
    require([
        ...
        // Declare widget.
        return declare('formtooltip.widget.FormTooltip', [ _WidgetBase, _Widget, _Templated, MasterTooltip ], {

            baseClass            : 'formtooltipFormTooltip',

            // Template path
            templatePath: require.toUrl('formtooltip/widget/templates/Tooltip.html'),
