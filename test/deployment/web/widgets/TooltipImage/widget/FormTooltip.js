...
/*global logger, mx, mxui, mendix, dojo, require, console, define, module, TooltipImage, dijit */
/**
...
(function() {
    ...
    require([
        ...
        return declare('TooltipImage.widget.FormTooltip', [ _WidgetBase, _Widget, _Templated, MasterTooltip ], {
            ...
            // Template path
            templatePath: require.toUrl('TooltipImage/widget/templates/Tooltip.html'),
